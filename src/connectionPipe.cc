...
bool ClientConnectionPipe::start(uint16_t port, std::string server, PipeInterface *upStream) {
...
void ServerConnectionPipe::processSyn(std::unique_ptr<MediaNet::Packet> &packet) {
	std::clog << "Got a Syn"
